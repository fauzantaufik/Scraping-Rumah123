...
if __name__ == '__main__' :
    ...
    url = 'https://www.rumah123.com/jual/residensial/?q=rawabuntu'
    house_data_list = []
    curr_page = 1
    continue_scrap = True
    try :
        while continue_scrap :
            ...
            for page in all_pagination :
                if str(page.text) == str(curr_page + 1) :
                    continue_scrap = True
                    curr_page += 1
                    url = f'https://www.rumah123.com/jual/residensial/?q=rawabuntu&page={curr_page}'
                    break
    except Exception as e :
